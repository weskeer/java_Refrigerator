...
public class GUI extends JFrame {
    ...
    private JFrame frame = new JFrame("窗口标题");
...
//        };
        ...
        recipeb = new JButton("食譜");
        recipeb.setSize(40, 40);
        recipeb.addActionListener(handler);
        ...
        buttonPanel.add(recipeb,BorderLayout.EAST);
...
//            String icon_path = newItemIcon.getText();
    ...
    private void reciperand() {
        recipe recipec = recipee.RandomRecipe();
        if (recipec != null) {
            JOptionPane.showMessageDialog(frame,
                "名称: " + recipec.getName() + "\n" +
                "成分: " + recipec.getIngredients() + "\n" +
                "步骤: " + recipec.getInstructions(),
                "推荐食谱",
